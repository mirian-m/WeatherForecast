...
class CurrentWeatherRouter: NSObject, CurrentWeatherRoutingLogic, CurrentWeatherDataPassing {
  ...
  // MARK: Routing
    ...
    func navigateToWeatherDetails(source: CurrentWeatherViewController, destination: UIViewController) {
        source.show(destination, sender: nil)
    }
    
    //   MARK: Passing data
    func passDataToSomewhere(source: CurrentWeatherDataStore, destination: inout WeatherDetailsDataStore) {
